...
// 할당 정책을 변경하려면 아래 중 하나의 주석을 해제하세요:
//////////////////////////////////////////////////////////////////////////////////

// #define ALLOCATION_POLICY_1  // Channel → Way → Page → Block (기본값, 최고 성능)
// #define ALLOCATION_POLICY_2  // Way → Channel → Block → Page (균등 부하 분산)
// #define ALLOCATION_POLICY_3  // Block → Page → Way → Channel (순환, 마모 균등화)
// #define ALLOCATION_POLICY_4  // Page → Block → Channel → Way (역순환, 특수 최적화)
